...
export class GameCategoryService {
  ...
  getGameCategories(): Observable<BaseResponse<GameCategoryList[]>> {
    return this.http.get<BaseResponse<GameCategoryList[]>>(`${this.baseUrl}${API.game_category_api.get_game_category}`);
  }
